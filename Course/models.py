...
class Teacher(models.Model):
    ...
    groups = models.ManyToManyField(LearnGroup, verbose_name='Группы', related_name='teachers')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Зарегестрирован')
...
class Schedule(models.Model):
    ...
    theme = models.CharField(max_length=128, verbose_name='Тема урока', default='Тема не задана!')
    weekday = models.DateField(verbose_name='День недели')
    time_lesson = models.TimeField(verbose_name='Время')
    lesson_materials = RichTextUploadingField(verbose_name='Материалы к уроку', unique=False,
    ...
    lesson_type = models.CharField(max_length=64, choices=LESSONG_TYPE_CHOICES, default='Практика',
...
class StudentQuestion(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Задан', null=True)
